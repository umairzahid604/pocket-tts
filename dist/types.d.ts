...
export interface TTSError extends Error {
    ...
    code: 'PYTHON_NOT_FOUND' | 'POCKET_TTS_NOT_INSTALLED' | 'VOICE_CLONING_NOT_AVAILABLE' | 'INVALID_VOICE' | 'GENERATION_FAILED' | 'FFMPEG_ERROR' | 'BRIDGE_ERROR';
    /** Setup instructions if applicable */
    setupInstructions?: string;
}
/** Predefined voice names available without voice cloning */
export declare const PREDEFINED_VOICES: readonly ["alba", "marius", "javert", "jean", "fantine", "cosette", "eponine", "azelma"];
